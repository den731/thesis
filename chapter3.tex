...
Orthophosphate was shown to be significant in predicting \gls{lcmsms}. This was more apparent with lakes with high levels of \gls{mc}, in particular with Brighton lake. However, there was an instance of high orthophosphate levels in Stoney Lake but this was probably due to the lake level manually dropped in October
%The bioavailability of phosphorus is pH dependent, where most is available between when in alkaline conditions with a pH$>$8 \cite{lucas_relationships_1961}.
