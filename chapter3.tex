...
A subset analysis was done on the full model including the variables chosen which was found to be significant from the correlation matrix. The best subset analysis is done with the largest subset size of 3 (nvmax=3) and 5 subsets of each size to record (nbest=5). (see figure \ref{subset}). 
